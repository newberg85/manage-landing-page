...
export default function Header() {
    return (
        <>
        <footer className="bg-very-dark-blue w-screen h-full justify-between px-4 mx-auto lg:max-w-full md:items-center md:flex md:px-36">
            <div className='w-full flex justify-between mb-10 mt-10'>
                <div className='flex flex-col justify-between'>
                    ...
                    <Link href="/">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className='fill-white hover:fill-orange'>
                    ...
                    <Link href="/">
                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" className='fill-white hover:fill-orange'>
                ...
                <div className='flex justify-around text-center w-full'>
                    <ul>
                        <li className="text-base text-white py-2 md:px-6 text-center border-b-2 md:border-b-0  hover:bg-purple-900  border-purple-900  md:hover:text-orange md:hover:bg-transparent">
                            <Link href="/">
                                Home
                            </Link>
                        </li>
                        <li className="text-base text-white py-2 px-6 text-center  border-b-2 md:border-b-0  hover:bg-purple-600  border-purple-900  md:hover:text-orange md:hover:bg-transparent">
                            <Link href="#pricing">
                                Pricing
                            </Link>
                        </li>
                        ...
                        <li className="text-base text-white py-2 px-6 text-center  border-b-2 md:border-b-0  hover:bg-orange  border-purple-900  md:hover:text-orange md:hover:bg-transparent">
                            <Link href="#aboutus">
                                About us
                            </Link>
                        </li>
                ...
                <div>
                    <form action="" className='flex gap-2'>
                        <input type="email" placeholder='Updates in your inbox…' className='p-2 focus:outline-none rounded-3xl'/>
                        <button className="w-14 text-sm p-2 text-white rounded-3xl bg-orange shadow-lg hover:bg-orange-pale">Go</button>
                    </form>
