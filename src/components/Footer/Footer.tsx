...
export default function Header() {
    return (
        <>
        <footer className="bg-very-dark-blue w-screen h-full justify-between px-4  lg:max-w-screen md:items-center md:flex md:px-36">
            <div className='w-full flex flex-col-reverse sm:flex-row items-center sm:items-start justify-between mb-10 mt-10 gap-8 '>
                <div className='flex items-center sm:items flex-col-reverse sm:flex-col justify-between gap-8 sm:gap-0'>
                    {/* Logo */}
                    <Link href="/">
                    <Image 
                    className='w-48'
                    ...
                    {/* Social */}
                    <div className='flex gap-6 sm:gap-2 mt-0 sm:mt-28'>
                    <Link href="/">
                        <Image 
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className='hidden md:block fill-white hover:fill-orange'>
                            <path d="M18.896 0H1.104C.494 0 0 .494 0 1.104v17.793C0 19.406.494 20 1.104 20h9.58v-7.745H8.076V9.237h2.606V7.01c0-2.583 1.578-3.99 3.883-3.99 1.104 0 2.052.082 2.329.119v2.7h-1.598c-1.254 0-1.496.597-1.496 1.47v1.928h2.989l-.39 3.018h-2.6V20h5.098c.608 0 1.102-.494 1.102-1.104V1.104C20 .494 19.406 0 18.896 0z"/>
                        </svg>
                    </Link>
                    ...
                    <Link href="/">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" className='hidden md:block fill-white hover:fill-orange'>
                ...
                <div>
                    <form action="" className='w-full flex gap-2'>
                        <input type="email" placeholder='Updates in your inbox…' className='w-full sm:w-80 p-2 focus:outline-none rounded-3xl'/>
                        <button className="w-20 text-sm p-2 text-white rounded-3xl bg-orange shadow-lg hover:bg-orange-pale">Go</button>
                    </form>
